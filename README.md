...
* Install _apache2_ and _rapache_:
...
* Install _R_ modules _Rook_, and dependencies.

* Configure _httpd_ by linking `rapache.conf` into the configuration
   directory:
...
* Edit settings in `rapache.conf` to point to the socure
